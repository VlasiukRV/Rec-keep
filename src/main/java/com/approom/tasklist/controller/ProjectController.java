...
public class ProjectController extends BaseEntityController<ProjectRepository, Integer, Project, ProjectService>{

    @Autowired
    public ProjectController(ProjectService entityService) {
        entityName = "project";
