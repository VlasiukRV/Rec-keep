...
import com.approom.cashaccounting.service.CashFlowService;
...
@RestController
@RequestMapping(value = "/appCashAccounting/entity/cashFlow")
public class CashFlowController extends BaseEntityController {
    @Autowired
    public CashFlowController(CashFlowService entityService) {
        entityName = "cashFlow";
